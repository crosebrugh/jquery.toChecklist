...
(function($) {
  ...
  $.fn.clearableTextField = function(fn) {
    _fn = fn;
  ...
  function trigger(input, set_focus) {
    if ((input.val().length>0) && (input.val() != input.data('default-value'))) {
  ...
  function add_clear_button(input, set_focus) {
    if (input.attr('has_clearable_button')!="1") {
      ...
      input.css('padding-right', parseInt(input.data('original-padding-right'),10) + w + 1);
  ...
  function remove_clear_button(input, set_focus) {
    ...
    if (input.attr('has_clearable_button')=="1") {
      ...
      input.css('padding-right', parseInt(input.data('original-padding-right'),10));
